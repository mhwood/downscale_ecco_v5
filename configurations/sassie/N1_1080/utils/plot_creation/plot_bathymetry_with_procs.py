...
def plot_bathymetry_with_procs():
    ...
    bathy_file = os.path.join('..', 'input', 'bathy_N1_no_walls')
    ...
    plt.plot(bathy_grid_faces[1][0, :])
    plt.plot(bathy_grid_faces[1][1, :])
    plt.plot(bathy_grid_faces[1][2, :])
    plt.plot(bathy_grid_faces[1][3, :])
    plt.plot(bathy_grid_faces[1][4, :])
    plt.show()
