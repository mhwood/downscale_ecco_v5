...
if print_tar_lines:
    tar_dir = '/Volumes/ifenty/Wood/Projects/Ocean_Modeling/Projects/Downscale_ECCOv5_Arctic/MITgcm/configurations/arctic_ECCOv5_forcing/N1_1080/results/N1_domain/tar_scripts'
    ...
    for number in numbers:
        ...
        for var_name in var_names:
            ...
            command = 'tar -czvf ../../../results/N1_domain/'+var_name+'/'+var_name+'.000'+str(number)+'0000.tar.gz '+var_name+'.000'+str(number)+'*'
            # print(command)
            output += command + '\n'
...
if print_Lou_copy_lines:
    ...
    lou_dir = '/Volumes/ifenty/Wood/Projects/Ocean_Modeling/Projects/Downscale_ECCOv5_Arctic/MITgcm/' \
    ...
    for number in numbers:
        ...
        output = ''
        for var_name in var_names:
            command = 'mv '+path_name+'/'+var_name+'/'+var_name+'.000'+str(number)+'0000.tar.gz '+var_name+'/'
            output+=command+'\n'
